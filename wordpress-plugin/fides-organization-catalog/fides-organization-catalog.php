...
define('FIDES_ORG_CATALOG_VERSION', '1.14.28');
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php echo esc_html__('Links visitors to the Pro Plan page so they can manage their Official Listing.', 'fides-organization-catalog'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
