...
class Fides_Organization_Catalog {
    ...
    public function register_assets() {
        ...
        $ui_lib_css_version = file_exists($ui_lib_css_path) ? filemtime($ui_lib_css_path) : '1.3.14';
        $ui_lib_js_version = file_exists($ui_lib_js_path) ? filemtime($ui_lib_js_path) : '1.3.14';
